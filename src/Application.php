...
class Application implements \ArrayAccess {
    ...
    public function withFacades() {
        ...
        if (!static::$aliasesRegistered) {
            ...
            class_alias('Lee\Facades\App', 'App');
            class_alias('Illuminate\Support\Facades\DB', 'DB');
            class_alias('Lee\Facades\View', 'View');
            class_alias('Lee\Facades\Log', 'Log');
            class_alias('Lee\Facades\Request', 'Request');
            class_alias('Lee\Facades\Response', 'Response');
            class_alias('Lee\Facades\Router', 'Router');
            class_alias('Lee\Facades\Session', 'Session');
            class_alias('Lee\Facades\Cookie', 'Cookie');
        }
    }
